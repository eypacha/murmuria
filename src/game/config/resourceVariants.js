...
export const BUSH_VARIANT_CONFIGS = BUSH_VARIANT_INDICES.map((index) => ({
  key: `bush_${index}`,
  path: `/assets/terrain/decorations/bushes/bush-${index}.png`,
  frameWidth: 128,
  frameHeight: 128,
  displayWidth: BUSH_DISPLAY_SIZE,
  displayHeight: BUSH_DISPLAY_SIZE,
}))
